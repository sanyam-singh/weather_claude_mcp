...
1. Use `get_district_crops` to get Darbhanga-specific crop information
2. Consider current season (Kharif/Rabi/Zaid)
3. Provide planting recommendations
4. Show crop calendar information
...
**Claude Response**: Claude will:
1. Generate a weather alert for Gaya
2. Use `generate_agent_messages` to create formatted messages
3. Provide SMS-optimized short messages
4. Create rich WhatsApp messages with emojis and formatting
...
1. Use the `help_bihar_agmcp` tool within Claude
